...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden rounded-3xl border border-white/60 bg-white/85 px-6 py-10 shadow-soft sm:px-10 sm:py-14">
      <div className="absolute inset-x-0 top-0 h-1/2 bg-gradient-to-r from-brand-600 via-accent-500 to-guinea-600 opacity-95" />
      ...
      <div className="relative mt-10 max-w-2xl sm:mt-12">
        ...
        <p className="mt-4 max-w-xl text-sm text-white/92 sm:text-base">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <Link
            to="/panier"
            className="rounded-xl border border-white/60 bg-white/10 px-5 py-3 text-sm font-semibold text-white transition hover:bg-white/20"
          >
            Commander maintenant
          </Link>
        </div>
        <p className="mt-6 inline-flex rounded-full border border-white/35 bg-white/15 px-3 py-1 text-xs font-semibold text-white">
          {TRUST_BANNER}
        </p>
      </div>
    </section>
