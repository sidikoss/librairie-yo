...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-white/40 px-6 py-14 shadow-2xl sm:px-12 sm:py-20">
      {/* Multi-layer gradient background */}
      <div className="absolute inset-0 bg-gradient-to-br from-brand-500 via-brand-600 to-guinea-700" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(255,255,255,0.3),transparent_40%)]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_80%,rgba(244,196,48,0.2),transparent_40%)]" />
      <div className="absolute inset-0 bg-slate-900/10" />

      {/* Animated floating shapes */}
      <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
        <div className="absolute -right-8 top-8 h-32 w-32 rounded-full border-2 border-white/10 animate-float-slow" />
        <div className="absolute -left-4 bottom-12 h-20 w-20 rounded-2xl border-2 border-white/10 rotate-12 animate-float" />
        <div className="absolute right-1/4 top-1/3 h-16 w-16 rounded-full bg-white/5 animate-float-delayed" />
        <div className="absolute left-1/3 bottom-1/4 h-24 w-24 rounded-3xl border border-accent-400/20 rotate-45 animate-float-slow" />
        <div className="absolute right-12 bottom-8 h-10 w-10 rounded-full bg-accent-400/10 animate-float" />
      </div>
      ...
      <div className="relative max-w-2xl">
        ...
        <div className="mt-8 flex flex-wrap gap-3 opacity-0-initial animate-fade-in-up delay-600 fill-forwards">
          <Link
            to="/catalogue"
            className="group rounded-2xl bg-white px-6 py-3.5 text-sm font-bold text-brand-700 shadow-xl shadow-brand-900/20 transition-all duration-300 hover:-translate-y-1 hover:bg-slate-50 hover:shadow-2xl"
          >
          ...
          <Link
            to="/panier"
            className="rounded-2xl border border-white/30 bg-white/10 px-6 py-3.5 text-sm font-semibold text-white backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:bg-white/20 hover:shadow-lg"
          >
        ...
        <div className="mt-8 opacity-0-initial animate-fade-in-up delay-700 fill-forwards">
          <p className="inline-flex items-center gap-2.5 rounded-full border border-white/40 bg-white/90 px-4 py-2 text-xs font-semibold text-slate-800 shadow-lg backdrop-blur-sm">
