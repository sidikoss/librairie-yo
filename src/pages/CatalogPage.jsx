      ...
      <section className="card-surface p-5">
        <div className="mb-3 flex items-center gap-2">
          ...
          {(query || category || minPrice || maxPrice) && (
            <button
              ...
              className="ml-auto text-xs font-medium text-zinc-400 transition-colors hover:text-brand-500 dark:hover:text-brand-400"
            >
              Réinitialiser
            </button>
          )}
        ...
        <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-5">
          <div className="relative lg:col-span-1">
            <svg xmlns="http://www.w3.org/2000/svg" className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-zinc-400 dark:text-zinc-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
